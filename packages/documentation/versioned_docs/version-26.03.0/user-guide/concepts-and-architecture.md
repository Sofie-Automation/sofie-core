...
The Part is the playable element inside of a [Segment](#segment). This is the thing that starts playing when the user does a [TAKE](features/sofie-views-and-screens#take-point). A Playing part is _On Air_ or _current_, while the part "cued" to be played is _Next_.
...
The Timeline is stored by Sofie&nbsp;Core in a MongoDB collection. It is generated whenever a user does a [Take](features/sofie-views-and-screens#take-point), changes the [Next-point](features/sofie-views-and-screens#next-point) or anything else that might affect the playout.
...
- The [currently playing Part](features/sofie-views-and-screens#take-point)
- The [Next'ed Part](features/sofie-views-and-screens#next-point) and Parts that come after it \(the [Lookahead](features/sofie-views-and-screens#lookahead)\)

...
export const ConfigManifestOAuthFlowComponent: React.ComponentType<IConfigManifestOAuthFlowComponentProps> =
	withTranslation()(
								...
								{!secretStatus.credentials ? (
									<label className="field">
										...
										<div>
											...
											<div>
												<a
													href={device.configManifest.deviceOAuthFlow!.credentialsURL}
													target="_blank"
													rel="noreferrer"
												>
